...
struct MapProgramParams
{
  ...
  BIND_PROGRAMS(MapProgramParams, Program::Area, Program::Area3d, Program::Area3dOutline,
                Program::AreaOutline, Program::Bookmark, Program::BookmarkAnim,
                Program::BookmarkAnimBillboard, Program::BookmarkBillboard, Program::CapJoin,
                Program::CirclePoint, Program::ColoredSymbol, Program::ColoredSymbolBillboard,
                Program::DashedLine, Program::HatchingArea, Program::Line, Program::MaskedTexturing,
                Program::MaskedTexturingBillboard, Program::PathSymbol, Program::Text,
                Program::TextBillboard, Program::TextFixed, Program::TextFixedBillboard,
                Program::TextOutlined, Program::TextOutlinedBillboard, Program::Texturing,
                Program::TexturingBillboard, Program::BookmarkAboveText,
...
struct RouteProgramParams
{
  ...
  BIND_PROGRAMS(RouteProgramParams, Program::Route, Program::RouteDash, Program::RouteArrow,
                Program::RouteMarker)
} ALIGNMENT;
...
struct TrafficProgramParams
{
  ...
  BIND_PROGRAMS(TrafficProgramParams, Program::Traffic, Program::TrafficLine,
...
struct TransitProgramParams
{
  ...
  BIND_PROGRAMS(TransitProgramParams, Program::Transit, Program::TransitCircle,
...
struct GuiProgramParams
{
  ...
  BIND_PROGRAMS(GuiProgramParams, Program::TextStaticOutlinedGui, Program::TextOutlinedGui,
                Program::TexturingGui, Program::Ruler)
} ALIGNMENT;
...
struct Arrow3dProgramParams
{
  ...
  BIND_PROGRAMS(Arrow3dProgramParams, Program::Arrow3d, Program::Arrow3dShadow,
...
struct SMAAProgramParams
{
  ...
  BIND_PROGRAMS(SMAAProgramParams, Program::SmaaEdges, Program::SmaaBlendingWeight,
                Program::SmaaFinal)
} ALIGNMENT;
...
struct Car3dProgramParams
{
  ...
  BIND_PROGRAMS(Car3dProgramParams, Program::Car3D)
} ALIGNMENT;
...
public:
  ...
  virtual void Apply(ref_ptr<dp::GraphicsContext> context, ref_ptr<dp::GpuProgram> program,
                     Car3dProgramParams const & params) = 0;
};
}  // namespace gpu
